...
import com.example.coderspeak.mvppattern.adapters.CurrentRecyclerAdapter;
...
public class CurrentFragment extends Fragment implements CurrentMVP.View {
    ...
    public void setRecyclerView() {
        ...
        adapter = new CurrentRecyclerAdapter(getContext(), shoppingList, realm, false, presenter);

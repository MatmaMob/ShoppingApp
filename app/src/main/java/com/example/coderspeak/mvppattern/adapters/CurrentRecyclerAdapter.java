...
public class CurrentRecyclerAdapter extends RecyclerView.Adapter<CurrentRecyclerAdapter.FragmentViewHolder> {
    private List<ShoppingList> shoppingList;
    private Realm realm;
    private Context c;

    private CurrentMVP.Presenter presenter;
    boolean isArchieved;

    public CurrentRecyclerAdapter(Context c, List<ShoppingList> shoppingList, Realm realm, boolean isArchieved, CurrentMVP.Presenter presenter) {
